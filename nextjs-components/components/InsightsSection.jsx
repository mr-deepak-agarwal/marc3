      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            ...
            >
              <div className={`relative rounded-3xl overflow-hidden ${index === 0 ? 'h-full min-h-[500px]' : 'h-[280px]'}`}>
                <Image
                  src={insight.image}
                  alt={`${insight.title} - MARC business insights`}
                  fill
                ...
                <div className="absolute inset-0 p-6 lg:p-8 flex flex-col justify-end">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <time className="flex items-center gap-1 text-white/70 text-sm">
                  ...
                  <h3
                    className={`font-serif text-white mb-3 transition-colors group-hover:text-emerald-300 tracking-tight ${
                      index === 0 ? 'text-2xl lg:text-3xl font-medium' : 'text-xl font-medium'
                    }`}
                  >
                    {insight.title}
                  </h3>
