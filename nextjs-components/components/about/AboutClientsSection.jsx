...
const clientLogos = [
  ...
  { name: 'Dr. Batra\'s', logo: 'https://www.marcglocal.com/wp-content/uploads/2022/04/drbatras.png' },
  { name: 'Royal Orchid Hotels', logo: 'https://www.marcglocal.com/wp-content/uploads/2022/04/royal-orchid.png' },
  { name: 'Tito\'s', logo: 'https://www.marcglocal.com/wp-content/uploads/2022/04/titos.png' },
  { name: 'Planet Hollywood', logo: 'https://www.marcglocal.com/wp-content/uploads/2022/04/planet-hollywood.png' },
  ...
  { name: 'Pivot Capital', logo: 'https://www.marcglocal.com/wp-content/uploads/2022/04/pivot-capital.png' },
]
...
const caseStudies = [
  ...
  {
    client: 'Dr. Batra\'s',
    description: 'Conducted profitability analysis to improve operational efficiency and bottom line.',
    industry: 'Healthcare',
  },
  {
    client: 'Magsons',
    description: 'Delivered profitability analysis and MIS reporting solutions.',
    industry: 'Retail',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <header className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            We ensure our clients not just our services, but our warm care and personalized understanding of how they want to run their business. Their business becomes a part of us.
          </p>
        </header>
