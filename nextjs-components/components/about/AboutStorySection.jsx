...
import { Target, Eye, Compass, Award, Users, Globe, TrendingUp, Shield } from 'lucide-react'
    ...
    <section id="story" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          {/* Timeline Line */}
          <div className="absolute left-1/2 top-24 bottom-0 w-px bg-emerald-200 hidden lg:block" />
          ...
          <div className="space-y-8 lg:space-y-0">
            {timeline.map((item, index) => (
              ...
              >
                ...
                {/* Center Dot */}
                <div className="lg:w-2/12 flex justify-center py-4 lg:py-8">
