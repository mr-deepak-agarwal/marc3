      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-emerald-100/80 max-w-3xl mx-auto">
            MARC is a family comprising of Chartered Accountants, Strategic Planners, Engineers, Company Secretaries, LLBs, and MBAs, each a stalwart in their respective fields.
          </p>
        </div>
